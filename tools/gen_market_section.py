...
# ---------- CONFIG (매일 갱신) ----------
XLSX = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/76c2f089-daily_20260813.xlsx"
DRAFT = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/ffd7d231-20260813.html"
PUB = "archive/2026-08-12.html"      # 구조 추출용 직전 발행본
OUT = "archive/2026-08-13.html"      # 출력
BASE = "2026-08-12"                  # 종가 기준일 (Keys 시트 최근일자)
PUB_DATE = "2026.08.13"              # 발행일 (업데이트 표기)
GRAD = "813"                          # 차트 gradient id suffix (발행일)
...
# ---------- 팁 6개 (매일 재작성) ----------
TIPS = [
 '💡 <strong>코스피 6,579 — 전일 +3.68% 급등</strong>. <strong>외국인이 +2.67조 매수로 전환</strong>하며 상승을 견인했습니다. 코스닥은 859 보합권, <strong>닛케이는 67,524(+0.83%)로 사상 최고권</strong>입니다. 미국도 나스닥 +0.54%로 회복했습니다.',
 '💡 <strong>원/달러 1,419원 — 보합</strong>. 1개월 -5.61%의 원화 강세 기조가 유지되고 있습니다. <strong>엔화는 159.45엔</strong>입니다.',
 '💡 <strong>유가 급등 — 두바이유 +10.20%(88.99달러), WTI +6.42%(83.20달러), 브렌트유 +6.42%(88.91달러)</strong>. <strong>금도 4,383.00달러(+0.97%)</strong>로 사상 최고 행진을 이어갔고, 알루미늄 +2.85%로 원자재 전반이 강세입니다.',
 '💡 <strong>국고채 3년 3.791%(-1.7bp)</strong> — 상승세가 진정됐습니다. <strong>미국 10년물 4.692%(+0.8bp)</strong> 보합, 영국 10년물 4.978%입니다.',
 '💡 <strong>고객예탁금 97.93조 — 전일 -2.79조로 100조를 하회</strong>(8/11 집계). 랠리 속에 대기자금이 계속 시장으로 투입되고 있습니다. 신용잔고는 29.61조 보합입니다.',
 '💡 <strong>외국인 +2.67조 대량 매수 전환</strong> — 이날 급등의 주역입니다. <strong>개인은 -2.88조 차익실현</strong>, 기관 +0.38조입니다.',
]
...
CHARTS = [
 chart('kospi', '🇰🇷 KOSPI', pt2, pt0, pt0, pt0,
   '📖 KOSPI가 8월 12일 6,579pt로 전일 +3.68% 급등했습니다. 외국인이 +2.67조 원 매수로 전환하며 상승을 견인했습니다. 차트 기간(13개월) 누적은 {KOSPI_CHG}입니다.'),
