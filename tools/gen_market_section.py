...
# ---------- CONFIG (매일 갱신) ----------
XLSX = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/a9c11cda-daily_20260827.xlsx"
DRAFT = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/3ded1bc6-20260827.html"
PUB = "archive/2026-08-26.html"      # 구조 추출용 직전 발행본
OUT = "archive/2026-08-27.html"      # 출력
BASE = "2026-08-26"                  # 종가 기준일 (Keys 시트 최근일자)
PUB_DATE = "2026.08.27"              # 발행일 (업데이트 표기)
GRAD = "827"                          # 차트 gradient id suffix (발행일)
...
# ---------- 팁 6개 (매일 재작성) ----------
TIPS = [
 '💡 <strong>코스피 6,808 — 전일 +0.97%로 사흘 연속 상승</strong>했습니다(1주 +5.21%). <strong>외국인 순매도 규모가 -0.21조로 크게 줄어</strong> 매도 압력이 잦아든 모습입니다. <strong>닛케이도 66,262(+0.62%)</strong>로 올랐지만, 미국은 S&P500 -0.03%·나스닥 -0.13%로 관망세였습니다.',
 '💡 <strong>원/달러 1,383.5원(-0.32%)</strong> — 원화 강세가 이어졌습니다(1개월 -5.44%). <strong>엔화는 159.22엔</strong>으로 보합입니다.',
 '💡 <strong>유가가 급락했습니다 — WTI 82.36달러(-5.40%), 브렌트유 88.58달러(-6.16%), 두바이유 93.00달러(-4.92%)</strong>. 1개월 기준으로도 WTI -7.78%로 돌아섰습니다. 반면 <strong>금은 4,638.10달러(+0.30%)</strong>로 사상 최고권을 지켰고(1개월 +14.03%), 은은 68.64달러입니다.',
 '💡 <strong>미국 10년물 4.658%(+1.9bp)</strong> — 보합권입니다. 美 물가 압력이 남아 연준 금리동결 전망에 무게가 실립니다. <strong>국고채 3년 3.816%(-1.4bp), 회사채 4.500%(-1.6bp)</strong>로 국내 금리는 사흘째 하락했습니다.',
 '💡 <strong>고객예탁금 103.01조, 신용잔고 32.19조</strong> 수준입니다. 이번 자료의 자금 항목은 직전 집계치가 그대로 유지돼(미갱신) 증감보다 수준으로 보시는 편이 안전합니다.',
 '💡 <strong>외국인 -0.21조 — 사흘째 순매도이지만 규모는 급감</strong>했습니다(1주 누적 -6.20조). <strong>개인은 -2.05조로 차익실현</strong>, 기관이 +0.65조 매수했습니다.',
]
...
CHARTS = [
 chart('kospi', '🇰🇷 KOSPI', pt2, pt0, pt0, pt0,
   '📖 KOSPI가 8월 26일 6,808pt로 전일 +0.97%, 사흘 연속 올랐습니다(1주 +5.21%). 외국인 순매도 규모가 -0.21조 원으로 크게 줄며 매도 압력이 잦아들었습니다. 차트 기간(13개월) 누적은 {KOSPI_CHG}입니다.'),
