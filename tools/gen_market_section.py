...
# ---------- CONFIG (매일 갱신) ----------
XLSX = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/322eeef7-daily_20260828.xlsx"
DRAFT = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/d5d4aa88-20260828.html"
PUB = "archive/2026-08-27.html"      # 구조 추출용 직전 발행본
OUT = "archive/2026-08-28.html"      # 출력
BASE = "2026-08-27"                  # 종가 기준일 (Keys 시트 최근일자)
PUB_DATE = "2026.08.28"              # 발행일 (업데이트 표기)
GRAD = "828"                          # 차트 gradient id suffix (발행일)
...
# ---------- 팁 6개 (매일 재작성) ----------
TIPS = [
 '💡 <strong>코스피 6,912 — 전일 +1.53%로 나흘 연속 상승</strong>했습니다. 엔비디아 호실적에 반도체가 힘을 냈고, <strong>외국인이 +0.22조로 매수 전환</strong>했습니다. <strong>코스닥도 838(+1.30%)</strong> 동반 상승, 미국은 나스닥 +1.57%로 강세였습니다.',
 '💡 <strong>원/달러 1,386원(+0.22%)</strong> — 소폭 되돌렸지만 1개월 -5.27%의 원화 강세 기조는 유지됩니다. <strong>엔화는 159.42엔</strong>입니다.',
 '💡 <strong>유가 급락이 이어졌습니다 — 두바이유 87.10달러(-11.03%)</strong>가 특히 컸고, 브렌트유 87.84달러(-4.70%), WTI 82.23달러(-3.27%)입니다. <strong>금도 4,598.20달러(-0.92%)로 조정</strong>받아 4,600달러를 내줬습니다(1개월 +13.04%). 은은 67.99달러입니다.',
 '💡 <strong>국고채 3년 3.755%(-6.1bp), 회사채 4.448%(-5.2bp)로 큰 폭 하락</strong>했습니다. 반면 <strong>CD 91일물은 3.12%로 +15bp 급등</strong>해 단기자금 조달 비용이 튀었습니다. 미국 10년물은 4.666%(+0.2bp) 보합입니다.',
 '💡 <strong>고객예탁금 98.92조(-3.62조) — 100조선을 내줬습니다</strong>(8/26 집계). 반면 <strong>신용잔고 32.67조(+2,639억), 미수잔고 1.15조(+1,469억)</strong>로 레버리지는 계속 늘어 대비되는 흐름입니다.',
 '💡 <strong>외국인 +0.22조 — 나흘 만에 매수 전환</strong>(1주 누적은 여전히 -7.55조). <strong>개인은 -2.06조 차익실현</strong>, 기관 +0.24조입니다.',
]
...
CHARTS = [
 chart('kospi', '🇰🇷 KOSPI', pt2, pt0, pt0, pt0,
   '📖 KOSPI가 8월 27일 6,912pt로 전일 +1.53%, 나흘 연속 올랐습니다. 엔비디아 호실적에 반도체가 힘을 냈고 외국인이 +0.22조 원으로 매수 전환했습니다. 차트 기간(13개월) 누적은 {KOSPI_CHG}입니다.'),
