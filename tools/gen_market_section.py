...
# ---------- CONFIG (매일 갱신) ----------
XLSX = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/e6ff5ce7-daily_20260818.xlsx"
DRAFT = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/f87a015e-20260818.html"
PUB = "archive/2026-08-14.html"      # 구조 추출용 직전 발행본
OUT = "archive/2026-08-18.html"      # 출력
BASE = "2026-08-14"                  # 종가 기준일 (Keys 시트 최근일자)
PUB_DATE = "2026.08.18"              # 발행일 (업데이트 표기)
GRAD = "818"                          # 차트 gradient id suffix (발행일)
...
# ---------- 팁 6개 (매일 재작성) ----------
TIPS = [
 '💡 <strong>코스피 6,978 — 전일 +2.42%, 사흘 연속 급등</strong>으로 1주 +11.49%, 7,000선을 눈앞에 뒀습니다. <strong>외국인이 +2.97조로 사흘째 대규모 매수</strong>를 이어갔습니다. <strong>닛케이도 68,714(+0.59%)로 사상 최고 행진</strong>, 미국은 나스닥 -0.28%·S&P500 -0.17%로 숨 고르기입니다.',
 '💡 <strong>원/달러 1,418.5원(-0.04%)</strong> — 보합권입니다(1개월 -4.57% 원화 강세 기조). <strong>엔화는 159.32엔</strong>으로 소폭 강세입니다.',
 '💡 <strong>금 4,380.40달러(-0.65%) — 사상 최고권에서 소폭 조정</strong>(1개월 +7.86%). 유가도 되밀림 — WTI 82.40달러(-1.04%), 두바이유 88.50달러, 브렌트유 88.52달러. 은 64.99달러입니다.',
 '💡 <strong>미국 10년물 4.696%(+5.5bp)</strong> — 다시 반등해 4.7%선에 다가섰습니다. <strong>국고채 3년 3.796%(+1.5bp)</strong>, 영국 10년물은 5.046%(+9.5bp)로 급등해 눈에 띕니다.',
 '💡 <strong>고객예탁금 100.07조(+919억) — 100조선에 올라섰습니다</strong>(8/13 집계). 신용잔고 30.49조(+5,102억)로 증가세가 가팔라 레버리지 확대는 유의할 부분입니다. 수익증권도 +7.96조 증가입니다.',
 '💡 <strong>외국인 +2.97조 — 사흘 연속 대규모 순매수</strong>(1주 누적 +5.93조). <strong>개인은 -1.67조 차익실현 지속</strong>, 기관 -1.28조입니다.',
]
...
CHARTS = [
 chart('kospi', '🇰🇷 KOSPI', pt2, pt0, pt0, pt0,
   '📖 KOSPI가 8월 14일 6,978pt로 전일 +2.42%, 사흘 연속 급등했습니다(1주 +11.49%). 외국인이 +2.97조 원으로 사흘째 순매수를 이어가며 7,000선에 다가섰습니다. 차트 기간(13개월) 누적은 {KOSPI_CHG}입니다.'),
