...
# ---------- CONFIG (매일 갱신) ----------
XLSX = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/da48a147-daily_20260812.xlsx"
DRAFT = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/72e7ac71-20260812.html"
PUB = "archive/2026-08-11.html"      # 구조 추출용 직전 발행본
OUT = "archive/2026-08-12.html"      # 출력
BASE = "2026-08-11"                  # 종가 기준일 (Keys 시트 최근일자)
PUB_DATE = "2026.08.12"              # 발행일 (업데이트 표기)
GRAD = "812"                          # 차트 gradient id suffix (발행일)
...
# ---------- 팁 6개 (매일 재작성) ----------
TIPS = [
 '💡 <strong>코스피 6,346 — 전일 +0.73%, 이틀째 상승</strong>입니다. <strong>코스닥은 858(+0.39%)</strong>로 폭등 뒤 숨 고르기. 미국은 나스닥 -0.60%·S&P500 -0.35% 소폭 조정 — 저커버그의 "폐쇄형 AI 위험" 발언 등 AI 진영 논쟁이 이어졌습니다.',
 '💡 <strong>원/달러 1,420원 안팎 안정</strong> — 1개월 -5.58%로 원화 강세 기조가 유지되고 있습니다. <strong>엔화는 159.32엔</strong> 보합입니다.',
 '💡 <strong>유가 반등 — WTI +5.05%(82.13달러), 브렌트유 +4.99%(87.72달러)</strong>. <strong>금은 4,361.80달러(+0.49%)로 사상 최고권을 재경신</strong>했고(1주 +8.13%), 은도 65.11달러로 1주 +12.90% 랠리입니다.',
 '💡 <strong>국고채 3년 3.808%(+3.0bp)</strong> — 증시 회복에 채권 약세가 이어집니다. <strong>미국 10년물 4.735%(+3.7bp)</strong>로 상승 재개(1주 +10.8bp), 영국 10년물 5.037%.',
 '💡 <strong>고객예탁금 100.72조 — 전일 -3.49조</strong>(8/10 집계). 코스닥 폭등일에 대기자금이 시장으로 투입된 흐름입니다. <strong>신용잔고는 +7,757억</strong>으로 빚투가 다시 늘고, 수익증권도 +5.36조 증가했습니다.',
 '💡 <strong>수급 소강 — 외국인 -0.31조</strong>로 매도가 크게 둔화됐고, <strong>개인 +0.36조</strong>, 기관 -0.07조입니다. 급등락 후 관망 국면입니다.',
]
...
CHARTS = [
 chart('kospi', '🇰🇷 KOSPI', pt2, pt0, pt0, pt0,
   '📖 KOSPI가 8월 11일 6,346pt로 전일 +0.73% 상승, 이틀째 오름세입니다. 코스닥(858)도 폭등 뒤 상승을 지켰습니다. 차트 기간(13개월) 누적은 {KOSPI_CHG}입니다.'),
