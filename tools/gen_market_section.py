...
# ---------- CONFIG (매일 갱신) ----------
XLSX = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/53aacc0c-daily_20260826.xlsx"
DRAFT = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/81873739-20260826.html"
PUB = "archive/2026-08-25.html"      # 구조 추출용 직전 발행본
OUT = "archive/2026-08-26.html"      # 출력
BASE = "2026-08-25"                  # 종가 기준일 (Keys 시트 최근일자)
PUB_DATE = "2026.08.26"              # 발행일 (업데이트 표기)
GRAD = "826"                          # 차트 gradient id suffix (발행일)
...
# ---------- 팁 6개 (매일 재작성) ----------
TIPS = [
 '💡 <strong>코스피 6,743 — 전일 +0.68% 반등</strong>했습니다. 다만 <strong>외국인은 -3.68조로 이틀 연속 대규모 순매도</strong>(1주 누적 -9.45조)를 이어갔고, 개인 +0.91조·기관 +1.19조가 받아냈습니다. <strong>코스닥은 827로 +1.70%</strong> 더 크게 올랐고, 미국·일본 증시도 동반 상승했습니다.',
 '💡 <strong>원/달러 1,383원(-0.36%)</strong> — 원화 강세가 이어졌습니다(1개월 -5.47%). <strong>엔화는 159.23엔</strong>으로 보합입니다.',
 '💡 <strong>금 4,640.80달러(+0.36%) — 사상 최고를 재경신</strong>했습니다(1개월 +14.09%). 반면 <strong>유가는 되밀림 — WTI 85.01달러(-2.35%)</strong>, 브렌트유 92.17달러(-2.35%), 두바이유 97.90달러입니다. 은 68.54달러(-1.33%)입니다.',
 '💡 <strong>미국 10년물 4.661%(-4.3bp)</strong> — 이틀째 내리며 4.7% 아래로 내려왔습니다. <strong>국고채 3년 3.830%(-0.6bp)</strong>, 회사채 4.516%(-0.4bp)로 국내 금리도 안정적입니다. 다만 우량 회사채 금리가 연초 대비 1%p 넘게 뛴 점은 기업 자금조달에 부담입니다.',
 '💡 <strong>고객예탁금 103.01조, 신용잔고 32.19조(+2,096억)</strong>입니다(8/24 집계). <strong>신용잔고가 1주 새 +1.75조 늘어</strong> 레버리지 확대 속도가 빠른 점은 계속 유의할 부분입니다. 수익증권은 -4.41조 감소입니다.',
 '💡 <strong>외국인 -3.68조 — 이틀 연속 대규모 순매도</strong>(1주 누적 -9.45조). 韓美 금리 불확실성에 관망세가 이어지는 모습입니다. <strong>개인 +0.91조, 기관 +1.19조</strong>가 매수로 맞섰습니다.',
]
...
CHARTS = [
 chart('kospi', '🇰🇷 KOSPI', pt2, pt0, pt0, pt0,
   '📖 KOSPI가 8월 25일 6,743pt로 전일 +0.68% 반등했습니다. 다만 외국인은 -3.68조 원으로 이틀 연속 대규모 순매도를 이어갔고(1주 누적 -9.45조), 개인과 기관이 받아냈습니다. 차트 기간(13개월) 누적은 {KOSPI_CHG}입니다.'),
