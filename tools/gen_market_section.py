...
# ---------- CONFIG (매일 갱신) ----------
XLSX = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/8e3ef70e-daily_20260814.xlsx"
DRAFT = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/a931b65d-20260814.html"
PUB = "archive/2026-08-13.html"      # 구조 추출용 직전 발행본
OUT = "archive/2026-08-14.html"      # 출력
BASE = "2026-08-13"                  # 종가 기준일 (Keys 시트 최근일자)
PUB_DATE = "2026.08.14"              # 발행일 (업데이트 표기)
GRAD = "814"                          # 차트 gradient id suffix (발행일)
...
# ---------- 팁 6개 (매일 재작성) ----------
TIPS = [
 '💡 <strong>코스피 6,813 — 전일 +3.56%, 이틀 연속 급등</strong>으로 1주 +8.21%까지 회복했습니다. <strong>외국인이 +1.97조로 이틀째 매수</strong>를 이어갔습니다. <strong>닛케이도 68,309(+1.16%)로 사상 최고 경신</strong>, 미국은 나스닥 +0.81%·S&P500 +0.65% 강세입니다.',
 '💡 <strong>원/달러 1,420원(+0.47%)</strong> — 안정권입니다(1개월 -5.29% 원화 강세 기조). <strong>엔화는 159.49엔</strong> 보합입니다.',
 '💡 <strong>금 4,408.90달러(+1.08%) — 사상 최고 행진 지속</strong>(1개월 +7.43%). 유가도 강세 유지 — WTI 83.27달러(+1.39%), 두바이유 88.74달러, 브렌트유 88.98달러. 은 65.56달러입니다.',
 '💡 <strong>미국 10년물 4.631%(-5.1bp)</strong> — 하락 전환하며 부담을 덜었습니다. <strong>국고채 3년 3.781%(-1.0bp)</strong>, 영국 10년물 4.952%(-2.6bp)로 금리가 전반적으로 진정됐습니다.',
 '💡 <strong>고객예탁금 99.98조(+2.05조 회복)</strong> — 급등장에도 대기자금이 다시 유입됐습니다(8/12 집계). 신용잔고 29.98조(+3,670억), 수익증권도 +6.34조 증가로 자금 유입이 전방위적입니다.',
 '💡 <strong>외국인 +1.97조 — 이틀 연속 순매수</strong>(1주 누적 +1.84조 전환). <strong>개인은 -2.48조 차익실현 지속</strong>, 기관 +0.57조입니다.',
]
...
CHARTS = [
 chart('kospi', '🇰🇷 KOSPI', pt2, pt0, pt0, pt0,
   '📖 KOSPI가 8월 13일 6,813pt로 전일 +3.56%, 이틀 연속 급등했습니다(1주 +8.21%). 외국인이 +1.97조 원으로 이틀째 순매수를 이어갔습니다. 차트 기간(13개월) 누적은 {KOSPI_CHG}입니다.'),
