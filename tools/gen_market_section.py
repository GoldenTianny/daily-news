...
# ---------- CONFIG (매일 갱신) ----------
XLSX = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/0314506f-daily_20260825.xlsx"
DRAFT = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/e12193ed-20260825.html"
PUB = "archive/2026-08-24.html"      # 구조 추출용 직전 발행본
OUT = "archive/2026-08-25.html"      # 출력
BASE = "2026-08-24"                  # 종가 기준일 (Keys 시트 최근일자)
PUB_DATE = "2026.08.25"              # 발행일 (업데이트 표기)
GRAD = "825"                          # 차트 gradient id suffix (발행일)
...
# ---------- 팁 6개 (매일 재작성) ----------
TIPS = [
 '💡 <strong>코스피 6,697 — 전일 -3.12% 급락</strong>했습니다. 中 메모리 굴기 위협에 삼성전자가 -8.7% 급락한 여파가 컸고, <strong>외국인이 -3.43조 대규모 순매도</strong>였습니다. 개인이 +3.06조로 받아냈습니다. 반면 <strong>코스닥은 813으로 +1.42% 반등</strong>해 방향이 엇갈렸습니다.',
 '💡 <strong>원/달러는 1,388원 수준</strong>입니다(1개월 -6.37% 원화 강세 기조). 다만 이번 자료에서 원/달러·위안 시세는 직전 집계치가 그대로 유지돼(미갱신) 등락보다 수준으로 보시는 편이 안전합니다. <strong>엔화는 158.88엔</strong>입니다.',
 '💡 <strong>은 69.47달러(+5.68%) — 이틀 연속 급등</strong>했습니다(1개월 +18.07%). <strong>금은 4,624.10달러, 유가는 WTI 87.06달러·두바이유 97.81달러 수준</strong>이지만, 금·유가 시세는 이번 자료에서 미갱신이라 수준 참고용입니다. 알루미늄은 3,227달러(+1.11%)입니다.',
 '💡 <strong>미국 10년물 4.710%(-2.8bp)</strong> — 하락 전환하며 부담을 덜었습니다. <strong>국고채 3년 3.836%(-1.8bp), 회사채 4.520%(-2.2bp)</strong>로 국내 금리도 진정됐습니다.',
 '💡 <strong>고객예탁금 105.35조(-1.22조)</strong>로 소폭 감소했습니다(8/21 집계). <strong>신용잔고 31.45조(+5,757억), 미수잔고 1.10조(+1,839억)</strong>로 레버리지가 늘어난 점은 유의할 부분입니다. 수익증권은 +8.22조 증가입니다.',
 '💡 <strong>외국인 -3.43조 — 대규모 순매도</strong>(1주 누적 -5.65조). <strong>개인이 +3.06조로 저가 매수</strong>에 나섰고, 기관은 -1.27조입니다.',
]
...
CHARTS = [
 chart('kospi', '🇰🇷 KOSPI', pt2, pt0, pt0, pt0,
   '📖 KOSPI가 8월 24일 6,697pt로 전일 -3.12% 급락했습니다. 中 메모리 굴기 위협에 삼성전자가 급락한 여파로 외국인이 -3.43조 원 대규모 순매도에 나섰고, 개인이 +3.06조 원으로 받아냈습니다. 차트 기간(13개월) 누적은 {KOSPI_CHG}입니다.'),
