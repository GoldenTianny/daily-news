...
# ---------- CONFIG (매일 갱신) ----------
XLSX = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/ee83dfbf-daily_20260810.xlsx"
DRAFT = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/9d458536-20260810.html"
PUB = "archive/2026-08-07.html"      # 구조 추출용 직전 발행본
OUT = "archive/2026-08-10.html"      # 출력
BASE = "2026-08-07"                  # 종가 기준일 (Keys 시트 최근일자)
PUB_DATE = "2026.08.10"              # 발행일 (업데이트 표기)
GRAD = "810"                          # 차트 gradient id suffix (발행일)
...
# ---------- 팁 6개 (매일 재작성) ----------
TIPS = [
 '💡 <strong>코스피 6,259 — 전일 -0.60%</strong>, 급등락 한 주를 지나 숨 고르기입니다(1주 -5.10%). 코스닥도 799로 -0.36% 보합. 미국은 나스닥 +1.30%·S&P500 +0.62% 강세 — "AI 생산성 대폭발 초입" 낙관론이 지수를 밀었습니다.',
 '💡 <strong>원/달러 1,411원(-0.88%) — 1,410원대 진입</strong>, 1개월 -7.00%의 원화 초강세입니다. 외국인의 국내 은행 예치금이 25조 원에 달한다는 소식도 원화 수요를 보여줍니다. 엔화는 157.81엔입니다.',
 '💡 <strong>금 4,340.70달러(+2.24%) — 또 사상 최고 경신</strong>, 1주 +7.20%입니다. 은도 +1.99%(1주 +9.97%)로 귀금속 랠리가 이어집니다. 유가도 반등 — WTI +3.94%(78.18달러), 브렌트 +5.16%.',
 '💡 <strong>국고채 3년 3.746%(+0.4bp)</strong> — 안정권입니다. <strong>미국 10년물은 4.658%(-1.2bp)</strong>로 1주 -8.7bp 하락, 금리 급등세가 진정됐습니다.',
 '💡 <strong>고객예탁금 104.07조(+8,587억)·신용잔고 28.39조(+3,596억)</strong> — 폭락장 디레버리징이 일단락되고 자금이 다시 들어오는 모습입니다(8/6 집계). 수익증권은 -8.00조 감소.',
 '💡 <strong>외국인 -1.11조 매도 지속</strong>(1주 누적 -7.18조). <strong>개인 +0.61조·기관 +0.48조</strong>가 받아내는 구도가 이어지고 있습니다.',
]
...
CHARTS = [
 chart('kospi', '🇰🇷 KOSPI', pt2, pt0, pt0, pt0,
   '📖 KOSPI가 8월 7일 6,259pt로 전일 -0.60% 하락, 급등락 한 주를 지나 숨 고르기 국면입니다(1주 -5.10%). 외국인이 -1.11조 원 매도를 이어갔습니다. 차트 기간(13개월) 누적은 {KOSPI_CHG}입니다.'),
