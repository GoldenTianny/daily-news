...
# ---------- CONFIG (매일 갱신) ----------
XLSX = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/73882caf-daily_20260811.xlsx"
DRAFT = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/13ef7451-20260811.html"
PUB = "archive/2026-08-10.html"      # 구조 추출용 직전 발행본
OUT = "archive/2026-08-11.html"      # 출력
BASE = "2026-08-10"                  # 종가 기준일 (Keys 시트 최근일자)
PUB_DATE = "2026.08.11"              # 발행일 (업데이트 표기)
GRAD = "811"                          # 차트 gradient id suffix (발행일)
...
# ---------- 팁 6개 (매일 재작성) ----------
TIPS = [
 '💡 <strong>코스피 6,300 턱밑(+0.65%) — 코스닥이 854로 +6.97% 폭등</strong>하며 1주 +15.88%의 성장주 랠리가 가속됐습니다. 삼성전자의 최대 200조 원 주주환원 발표도 투자심리를 받쳤습니다. 닛케이 +2.08%, 미국은 나스닥 -0.32% 소폭 조정입니다.',
 '💡 <strong>원/달러 1,419원(+0.57%)</strong> — 급강세 후 되돌림입니다(1개월 -5.61%로 강세 기조 유지). <strong>엔화는 159.29엔(+0.87%)</strong>으로 소폭 약세 전환했습니다.',
 '💡 <strong>유가·금·은은 직전 거래일(8/7) 시세 수준 유지</strong> — WTI 78.18달러, 금 4,340.70달러(사상 최고권), 은 63.33달러. 알루미늄만 +1.56%(3,279.50달러)로 갱신 상승했습니다.',
 '💡 <strong>국고채 3년 3.778%(+3.2bp)</strong> — 증시 반등에 채권이 소폭 약세입니다. <strong>미국 10년물 4.707%(+4.9bp)</strong>, 영국 10년물은 5.001%로 5%를 재돌파했습니다.',
 '💡 <strong>고객예탁금 104.21조(+1,352억)·신용잔고 28.82조(+4,286억)</strong> — 이틀째 회복세로 투자심리가 살아나고 있습니다(8/7 집계). 수익증권은 -1.51조 감소.',
 '💡 <strong>기관 +1.14조 매수</strong>가 지수를 받쳤고, <strong>외국인은 -1.39조 매도 지속</strong>(1주 -5.54조), 개인 +0.23조입니다.',
]
...
CHARTS = [
 chart('kospi', '🇰🇷 KOSPI', pt2, pt0, pt0, pt0,
   '📖 KOSPI가 8월 10일 6,300pt로 전일 +0.65% 상승했습니다. 코스닥이 +6.97% 폭등(854)하며 성장주 랠리를 이끌었고, 삼성전자 주주환원 200조 발표가 힘을 실었습니다. 차트 기간(13개월) 누적은 {KOSPI_CHG}입니다.'),
