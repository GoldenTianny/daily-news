...
# ---------- CONFIG (매일 갱신) ----------
XLSX = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/cd08053d-daily_20260821.xlsx"
DRAFT = "/root/.claude/uploads/405f6ada-29ad-5785-ac2d-569e3af54ca7/1ac230c5-20260821.html"
PUB = "archive/2026-08-20.html"      # 구조 추출용 직전 발행본
OUT = "archive/2026-08-21.html"      # 출력
BASE = "2026-08-20"                  # 종가 기준일 (Keys 시트 최근일자)
PUB_DATE = "2026.08.21"              # 발행일 (업데이트 표기)
GRAD = "821"                          # 차트 gradient id suffix (발행일)
...
# ---------- 팁 6개 (매일 재작성) ----------
TIPS = [
 '💡 <strong>코스피 6,853 — 전일 +5.89% 급반등</strong>으로 전날 급락분(-5.80%)을 하루 만에 되돌렸습니다. SK하이닉스 자사주 매입과 미 재무부 국채 바이백이 반등 재료였고, <strong>외국인이 +1.58조로 매수 복귀</strong>했습니다. 반면 <strong>미국은 나스닥 -1.00%·다우 -1.23%</strong>로 약세라 방향이 엇갈렸습니다.',
 '💡 <strong>원/달러 1,390원(-1.94%) — 1,400원선이 무너졌습니다</strong>(1개월 -6.71%). 위험선호 회복과 함께 원화가 큰 폭으로 강세를 보였습니다. <strong>엔화는 159.03엔</strong>입니다.',
 '💡 <strong>금 4,489.40달러(+1.62%) — 사상 최고 재경신</strong>(1개월 +11.88%). <strong>두바이유가 93.60달러로 +6.55% 급등</strong>했고(1개월 +21.72%), WTI 85.83달러(+1.57%), 브렌트유 91.62달러입니다. 은은 65.73달러입니다.',
 '💡 <strong>미국 10년물 4.670%(+1.7bp)</strong> — 재무부의 금리 억제 총력전에도 보합권입니다. <strong>국고채 3년 3.811%(+1.3bp)</strong>, 회사채 4.504%(+0.7bp)로 국내 금리도 큰 변화 없습니다.',
 '💡 <strong>고객예탁금 106.58조(+1.82조) — 이틀 연속 증가</strong>하며 사상 최고 수준입니다(8/19 집계). 신용잔고 30.87조(+2,037억)인 반면, 수익증권은 -12.50조 급감했습니다.',
 '💡 <strong>외국인 +1.58조 — 하루 만에 매수 복귀</strong>. <strong>개인은 -2.27조로 차익실현</strong>했고, 기관 -0.38조입니다.',
]
...
CHARTS = [
 chart('kospi', '🇰🇷 KOSPI', pt2, pt0, pt0, pt0,
   '📖 KOSPI가 8월 20일 6,853pt로 전일 +5.89% 급반등하며 전날 급락분을 하루 만에 되돌렸습니다. 외국인이 +1.58조 원으로 매수에 복귀했습니다. 차트 기간(13개월) 누적은 {KOSPI_CHG}입니다.'),
